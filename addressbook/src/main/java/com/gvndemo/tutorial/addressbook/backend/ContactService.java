package com.gvndemo.tutorial.addressbook.backend;
...
public class ContactService {
    ...
    static String[] fnames = { "james", "kenn", "smith", "donald", "ivy",
            "harris", "ajay", "dany", "Don", "christopher", "black", "jio", "lee",
            "Linda", "Tim", "bore", "rita", "jelly", "ambro",
            "dumpy" };
    static String[] lnames = { "black", "smith", "trump", "jayesh",
            "lee", "cooper", "mith", "William","sun", "don",
            "Anderew", "Tom", "jacky", "sam", "margret", "newton",
            "brew", "kenny", "smith", "hill" };
